...
```bash
# 已經 clone 了 work-docs：做 symlink，之後 git pull 就會自動更新
ln -s ~/code/work-docs/skills/daily-worklog ~/.claude/skills/daily-worklog

# 換一台機器：直接抓資料夾
git clone git@github.com:henry5720/work-docs.git ~/code/work-docs
ln -s ~/code/work-docs/skills/daily-worklog ~/.claude/skills/daily-worklog
```
